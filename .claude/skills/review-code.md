...
- Optional: known conventions from `.claude/DEVELOPMENT.md` for the relevant module/client app.
...
3. **Cross-reference conventions**: check `.claude/DEVELOPMENT.md` for the relevant module/client app, if populated, to judge consistency rather than impose generic style opinions.
