...
5. **Update docs, if requested**: write/update a scoped entry in `.claude/PROJECT.md` (Backend Key Projects table) and/or `.claude/docs/generated/backend/modules/<ModuleName>/<ProjectName>/overview.md` using the [project-overview template](../docs/templates/project-overview.md). Only when explicitly asked.
