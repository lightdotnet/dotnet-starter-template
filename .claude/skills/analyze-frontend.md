...
5. **Update docs, if requested**: write/update `.claude/PROJECT.md` (Client Apps table) and/or `.claude/docs/generated/frontend-overview.md` (the clients index — see [frontend-overview template](../docs/templates/frontend-overview.md)). Only when explicitly asked.
