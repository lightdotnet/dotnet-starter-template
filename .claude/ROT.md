...
- [ ] `docs/KNOWN_DEBT.md` reflects current open backend items only — no resolved items lingering, and no debt duplicated back into `ARCHITECTURE-BACKEND.md`/`PROJECT-BACKEND.md`'s own sections (those should just point to it).
