...
features/users/components/users-page.tsx -> features/user-profile (resolveSession), features/users/api/users.api
                                        (searchUsers — changed this sync, was features/users/api/search-users),
...
features/roles/components/roles-page.tsx -> features/user-profile (resolveSession), features/roles/api/roles.api
                                        (getAllRoles — changed this sync, was features/roles/api/get-all-roles),
...
features/notifications/components/notifications-page.tsx -> features/user-profile (resolveSession, barrel),
                                        features/notifications/api/notifications.api (getNotifications — changed
                                        this sync, was features/notifications/api/get-notifications),
...
- **Hydration-safe browser-state restoration**: `hydrated` flag + `useEffect`, `eslint-disable react-hooks/set-state-in-effect`, in `SidebarProvider` and `AccentColorProvider`; `components/theme/use-has-mounted.ts` (`useSyncExternalStore`) guards `ThemeToggle`.
