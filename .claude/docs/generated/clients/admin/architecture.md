...
src/
  ...
  features/
    ...
    users/                  api/*.ts (13 endpoint files — the original 8 minus this sync's deletion of the unused
                             get-user-by-username.ts (7 remain, zero remaining references anywhere in src/), plus
                             create-user-action, update-user-action, force-password-action, delete-user-action,
                             get-user-detail-action, and — new this sync — search-users-action, all "use server"),
