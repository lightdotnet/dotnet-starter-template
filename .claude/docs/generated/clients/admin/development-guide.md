...
---
_Generated: 2026-08-03 (resynced — added Notifications feature: where-to-look bullets, permission/nav constants, SignalR proxy setup note) — scope: client app "admin" — see .claude/CLAUDE.md for update rules._
