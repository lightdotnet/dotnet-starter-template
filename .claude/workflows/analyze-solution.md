...
5. **Update documentation only if requested**:
   - Update the Modules table in `src/CLAUDE.md`.
   - Write/update `src/docs/architecture/overview.md` using [solution-overview template](../docs/templates/solution-overview.md).
...
- Optionally, updated `src/CLAUDE.md` entries and/or a generated backend overview doc.
