...
2. **Suggest documentation updates.** If code changed in ways that would make root `docs/integration.md`, `src/CLAUDE.md`/`src/docs/`, or `clients/<app-name>/CLAUDE.md`/`clients/<app-name>/docs/` stale, name specifically which doc(s) and why.
